...
function App() {
  ...
  const calcularIndicadores = () => {
    const totalOp = oportunidades.reduce((s, o) => s + parseFloat(o.valor || 0), 0);
        ...
        {viewMode === "clientes" && (
          <div className="space-y-3">
            ...
            <DataGrid columns={[
              ...
              { key: "telefone", label: "Telefone", filterValue: (c) => c.telefone || "", render: (c) => c.telefone || <span className="text-gray-300">-</span> },
